...
const FeatureList: FeatureItem[] = [
  {
    ...
    description: (
      <>
        Generate comprehensive documentation automatically from your CI/CD
        manifest files. No manual work required - just point CI Dokumentor at
        your files and get professional docs.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
        Works with GitHub Actions, GitHub workflows, GitLab templates, GitLab
        components and Dagger modules. Available as NPM CLI tool, Docker image,
        GitHub Action, and GitLab component for flexible integration.
      </>
    ),
  },
];
