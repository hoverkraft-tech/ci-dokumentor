...
export function initGlobalContainer(): Container {
  ...
  let nextContainer = coreInitContainer();
  nextContainer = gitInitContainer(nextContainer);
  nextContainer = githubInitContainer(nextContainer);
  nextContainer = gitlabInitContainer(nextContainer);
  nextContainer = githubActionsInitContainer(nextContainer);
  nextContainer = gitlabCIInitContainer(nextContainer);
  globalContainer = initContainer(nextContainer);
