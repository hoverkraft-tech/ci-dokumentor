...
describe("LoggerService", () => {
  ...
  describe("debug", () => {
    ...
    it("should throw error for unsupported format", () => {
      ...
      expect(() => loggerService.debug(message, "unsupported")).toThrow(
  ...
  describe("info", () => {
    ...
    it("should throw error for unsupported format", () => {
      ...
      expect(() => loggerService.info(message, "invalid")).toThrow(
  ...
  describe("warn", () => {
    ...
    it("should throw error for unsupported format", () => {
      ...
      expect(() => loggerService.warn(message, "unknown")).toThrow(
        "Unsupported output format: unknown",
      );
    });
  });
  ...
  describe("error", () => {
    ...
    it("should throw error for unsupported format", () => {
      ...
      expect(() => loggerService.error(message, "nonexistent")).toThrow(
        "Unsupported output format: nonexistent",
      );
    });
  });
  ...
  describe("result", () => {
    ...
    it("should throw error for unsupported format", () => {
      ...
      expect(() => loggerService.result(data, "badformat")).toThrow(
        "Unsupported output format: badformat",
      );
    });
  });
  ...
  describe("getLogger private method", () => {
    it("should handle case where no adapters are provided", () => {
      ...
      expect(() => emptyLoggerService.debug("test", undefined)).toThrow(
        "No logger adapters are configured",
      );
    });
  });
});
