...
import { LOGGER_ADAPTER_IDENTIFIER } from "./logger/adapters/logger.adapter.js";
...
import { PROGRAM_IDENTIFIER } from "./application/program.js";
...
import {
  GITHUB_OUTPUT_IDENTIFIER,
  GitHubActionLoggerAdapter,
} from "./logger/adapters/github-action-logger.adapter.js";
