    ...
    describe('getRepository', () => {
        it('should return repository information from parsed git URL', async () => {
            ...
            const mockParsedUrl = {
                ...
                toString: vi.fn().mockReturnValue('https://github.com/test-owner/test-repo.git')
            };
        ...
        it('should handle URL without .git suffix', async () => {
            ...
            const mockParsedUrl = {
                ...
                name: 'test-repo',
                full_name: 'test-owner/test-repo',
                toString: vi.fn().mockReturnValue('https://github.com/test-owner/test-repo')
            };
            mockGitUrlParse.mockReturnValue(mockParsedUrl);
        ...
        it('should throw error when no origin remote found', async () => {
            ...
            // Act & Assert
            await expect(provider.getRepository()).rejects.toThrow('No remote "origin" found');
        });
    });
