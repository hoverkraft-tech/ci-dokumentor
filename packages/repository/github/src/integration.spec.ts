...
describe('Integration: Auto-detection with real adapters', () => {
    beforeEach(() => {
    ...
    it('should auto-detect GitHub repository when using DI container', () => {
        ...
        // Act - Get the repository service which should have GitHub adapter registered
        ...
        // Verify that the repository service has adapters
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        expect((repositoryService as any).adapters).toBeDefined();
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        expect((repositoryService as any).adapters.length).toBeGreaterThan(0);
    });
});