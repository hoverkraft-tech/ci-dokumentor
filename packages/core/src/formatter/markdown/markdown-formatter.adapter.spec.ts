...
describe("MarkdownFormatterAdapter", () => {
  ...
  describe("heading", () => {
    it.each([
      ...
      {
        desc: "special-chars",
        content: new ReadableContent('Heading with "quotes" & symbols!'),
        expected: '# Heading with "quotes" & symbols!\n',
      },
      {
        desc: "numbers",
        content: new ReadableContent("Version 1.0.0 Release Notes"),
        expected: "# Version 1.0.0 Release Notes\n",
      },
  ...
  describe("paragraph", () => {
    it.each([
      {
        desc: "single-line",
        content: new ReadableContent("This is a paragraph"),
        expected: "This is a paragraph\n",
      },
      { desc: "empty", content: ReadableContent.empty(), expected: "\n" },
      {
        desc: "multi-line",
        content: new ReadableContent("First line\nSecond line"),
        expected: "First line\nSecond line\n",
      },
...
`);
    ...
    describe("URL transformation", () => {
      describe("autolink format (default)", () => {
        it.each([
          ...
          },
          {
            ...
            input:
              "> Here is some blockquote with a URL: https://example.com and an autolink <https://test.com> and a link [https://link.com](https://link.com)",
            expected:
              "> Here is some blockquote with a URL: <https://example.com> and an autolink <https://test.com> and a link [https://link.com](https://link.com)\n",
          },
          {
            ...
            input:
              "Here is some 😊 with a URL: https://example.com and an autolink <https://test.com> and a link [https://link.com](https://link.com). 😊",
            expected:
              "Here is some 😊 with a URL: <https://example.com> and an autolink <https://test.com> and a link [https://link.com](https://link.com). 😊\n",
          },
          {
            ...
            input:
              'Here is some code: `const url = "https://example.com";` and an autolink https://test.com',
            expected:
              'Here is some code: `const url = "https://example.com";` and an autolink <https://test.com>\n',
          },
          {
      ...
      describe("full link format", () => {
        it("should transform URLs to full links when linkFormat is Full", () => {
          ...
          expect(result.toString()).toEqual(
            "Visit [https://example.com](https://example.com) for more information\n",
          );
        });
        ...
        it("should transform multiple URLs to full links", () => {
          ...
          // Assert
          expect(result.toString()).toEqual(
            "Check [https://github.com](https://github.com) and [https://stackoverflow.com](https://stackoverflow.com)\n",
          );
        });
        ...
        it("should handle URLs with complex paths in full link format", () => {
          // Arrange
          const content = new ReadableContent(
            "API docs at https://api.example.com/v1/docs?format=json",
          );
          adapter.setOptions({ linkFormat: LinkFormat.Full });
          ...
          // Assert
          expect(result.toString()).toEqual(
            "API docs at [https://api.example.com/v1/docs?format=json](https://api.example.com/v1/docs?format=json)\n",
          );
        });
      });
      ...
      describe("edge cases", () => {
        ...
        it("should only transform http and https URLs", () => {
          // Arrange
          const content = new ReadableContent(
            "Visit https://example.com and ftp://files.com and mailto:test@example.com",
          );
          adapter.setOptions({ linkFormat: LinkFormat.Auto });
        ...
        it("should handle URLs with trailing punctuation", () => {
          // Arrange
          const content = new ReadableContent(
            "Check https://example.com, https://github.com. Also https://stackoverflow.com!",
          );
          adapter.setOptions({ linkFormat: LinkFormat.Auto });
  ...
  describe("bold", () => {
    it.each([
      ...
      {
        desc: "special",
        content: new ReadableContent('Text with "quotes" & symbols!'),
        expected: '**Text with "quotes" & symbols!**',
      },
...
`);
  ...
  describe("inlineCode", () => {
    it.each([
      ...
      {
        desc: "multiline",
        content: new ReadableContent("line1\nline2"),
        expected: "```text\nline1\nline2\n```\n",
      },
  ...
  describe("link", () => {
    it.each([
      {
        desc: "basic",
        text: new ReadableContent("GitHub"),
        url: new ReadableContent("https://github.com"),
        expected: "[GitHub](https://github.com)",
      },
      {
        desc: "empty text",
        text: ReadableContent.empty(),
        url: new ReadableContent("https://example.com"),
  ...
  describe("image", () => {
    it.each([
      {
        desc: "markdown image",
        alt: new ReadableContent("Alternative Text"),
        url: new ReadableContent("https://example.com/image.png"),
        options: undefined,
        expected: "![Alternative Text](https://example.com/image.png)",
      },
      {
        desc: "width",
        alt: new ReadableContent("Alternative Text"),
      ...
      },
      {
        ...
        alt: new ReadableContent("Alternative Text"),
        url: new ReadableContent("https://example.com/image.png"),
        options: { width: "300px", align: "center" },
        expected:
  ...
  describe("section", () => {
    it("should return input wrapped in section markers", () => {
      ...
      const result = adapter.section(
        ...
        new ReadableContent("Section Content"),
      );
