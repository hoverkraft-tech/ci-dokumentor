...
import { QuickstartSectionGenerator } from './section/quickstart-section-generator.adapter.js';
...
export function initContainer(): Container {
    ...
    container.bind(SECTION_GENERATOR_ADAPTER_IDENTIFIER).to(QuickstartSectionGenerator);
